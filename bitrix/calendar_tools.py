...
URL = f'https://supportua.bitrix24.ua/rest/2067/2ganq1hgz5etn112/calendar.event.get.json?type=user&ownerId={OWNER_ID}&section=259'
...
def add_event(start, end, name, deal_id):
    ...
    SEND_URL = f'https://supportua.bitrix24.ua/rest/2067/h77kc3hpgxie6dxl/calendar.event.add.json?type=user&ownerId=2067&from_ts={int(start)}&to_ts={int(end)}&section=259&name={name}&is_meeting=Y&attendees[]=355&attendees[]=78&attendees[]=383&attendees[]=178&attendees[]=253&description={link}'
